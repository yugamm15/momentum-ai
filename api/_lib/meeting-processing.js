...
import { dedupeParticipantDisplayNames } from './people-directory.js';
...
function dedupeNames(names) {
  return dedupeParticipantDisplayNames(
    (Array.isArray(names) ? names : []).map((name) => sanitizeOptionalField(name))
  );
}
